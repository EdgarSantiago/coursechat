...
<div class="container px-6 mx-auto bg-green-500 rounded-md shadow-md p-8">

	<!-- Section: Design Block -->
	<section class="text-white text-center">
	  <h2 class="text-3xl font-bold mb-12">Why is it so<u class="text-yellow-300"> great?</u></h2>
	  <div class="grid md:grid-cols-3 lg:gap-x-12">
		<div class="mb-12 md:mb-0">
		  <div class="p-4 bg-purple-400 rounded-lg shadow-lg inline-block mb-6">
		...
		<div class="mb-12 md:mb-0">
		  <div class="p-4 bg-blue-400 rounded-lg shadow-lg inline-block mb-6">
			<svg class="w-5 h-5 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
			  <path fill="currentColor"
		...
		<div class="mb-12 md:mb-0">
		  <div class="p-4 bg-yellow-400 rounded-lg shadow-lg inline-block mb-6">
